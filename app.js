...
const NAMA_STORE = vars.NAMA_STORE || '@NAPOLEON_ME';
...
let ADMIN_USERNAME = '@NAPOLEON_ME';
...
• 🏠 Menu Utama   : /start
• 🔑 Menu Admin   : /admin
• 🛡️ List Menu Admin : /helpadmin

👨‍💻 <b>Pembuat:</b> @NAPOLEON_ME
🛠️ <b>Credit:</b> NAPOLEON
...
bot.action('service_trial2', async (ctx) => {
  try {
    ...
    await ctx.reply(
      ...
      `👤 Admin: <a href="https://t.me/NAPOLEON_ME">@NAPOLEON_ME</a>\n` +
